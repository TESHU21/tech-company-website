...
export default function WhoWeAre() {
  return (
    <section id="about" className=" max-w-8xl mx-auto bg-background py-4 w-full">
      <div className=" mx-auto px-4 sm:px-6 lg:px-8 grid  grid-cols-1 md:grid-cols-2 gap-12 items-center md:mt-24">
